...
// Navigation icons as simple components for clarity
const IconTranslate = () => (
...
export const FloatingWindow: React.FC = () => {
  ...
  const validModes = ["translate", "word", "sentence", "wordbook", "wordbook-detail", "learning", "settings", "voicefollowup"];
        ...
        {showIdle && (
          <div className="idle-state">
            <div className="idle-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" opacity="0.5">
                <circle cx="12" cy="12" r="10" />
                <path d="M12 6v6l4 2" />
              </svg>
            </div>
            <h3 className="idle-title">Abandon</h3>
            <p className="idle-hint"><kbd>{modKey}+Shift+T</kbd> 直接翻译选中文本</p>
            <p className="idle-hint"><kbd>{modKey}+Shift+Y</kbd> 显示 / 隐藏窗口</p>
          </div>
        )}
      </div>
